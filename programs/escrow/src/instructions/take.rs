...
//mint defines the properties of a token, like its supply, name, and the number of decimals it supports. Think of it as the “template”
...
//TokenAccount is associated with a specific mint to know which type of token it is holding
